...
class GuideRailGenerator:
    ...
    def generate_rail(self):
        ...
        utilities.translate_atoms(narrow_atoms, samson.SBPhysicalVector3(SBQuantity.angstrom(0),
        ...
        utilities.translate_atoms(rail_atoms, samson.SBPhysicalVector3(SBQuantity.angstrom(0),
    ...
    def generate_clip(self):
        ...
        utilities.translate_atoms(anchor_atoms, samson.SBPhysicalVector3(SBQuantity.angstrom(0),
        ...
        utilities.translate_atoms(left_wall_atoms, samson.SBPhysicalVector3(SBQuantity.angstrom(anchor_min_x - left_wall_start_min_x),
        ...
        utilities.translate_atoms(right_wall_atoms, samson.SBPhysicalVector3(SBQuantity.angstrom(-(anchor_max_x - right_wall_max_x)),
                                                                 SBQuantity.angstrom(wall_bottom_y),
                                                                 SBQuantity.angstrom(0)))
        ...
        utilities.translate_atoms(left_retaining_atoms, samson.SBPhysicalVector3(SBQuantity.angstrom(anchor_min_x - left_retaining_start_min_x),
        ...
        utilities.translate_atoms(right_retaining_atoms, samson.SBPhysicalVector3(SBQuantity.angstrom(-(anchor_max_x - right_retaining_max_x)),
                                                                 SBQuantity.angstrom(retaining_bottom_y),
                                                                 SBQuantity.angstrom(0)))
